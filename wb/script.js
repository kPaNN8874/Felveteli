...
let BekertOMAz = document.getElementById(OM_Azonosito);
let Keresesbtn = document.getElementById(keres)
let array = [];
function Kereses(){
   Diakok.forEach(Diak => {
    if(Diakok.OM_Azonosito.length = 11 && Diakok.OM_Azonosito==BekertOMAz){}})
